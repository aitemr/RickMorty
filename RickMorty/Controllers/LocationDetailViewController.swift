...
final class LocationDetailViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            iconContainer.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 30),
            ...
            favoriteButton.centerYAnchor.constraint(equalTo: iconContainer.centerYAnchor),
            favoriteButton.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            favoriteButton.widthAnchor.constraint(equalToConstant: 44),
            favoriteButton.heightAnchor.constraint(equalToConstant: 44),

            nameLabel.topAnchor.constraint(equalTo: iconContainer.bottomAnchor, constant: 16),
    ...
    private func configure() {
        ...
        let rows: [(String, String)] = [
            ...
            ("Residents", "\(location.residents.count) resident(s)"),
        ]
    ...
    private func updateFavoriteButton() {
        let isFav = FavoritesManager.shared.isLocationFavorite(location.id)
