...
nonisolated private enum EpisodeSection: Int, Hashable, Sendable {
    case main
}
...
final class EpisodesViewController: UIViewController {
    ...
    private var dataSource: UICollectionViewDiffableDataSource<EpisodeSection, RMEpisode>!
    ...
    private func configureDataSource() {
        dataSource = UICollectionViewDiffableDataSource<EpisodeSection, RMEpisode>(
            collectionView: collectionView
        ) { (collectionView: UICollectionView, indexPath: IndexPath, episode: RMEpisode) -> UICollectionViewCell? in
    ...
    private func applySnapshot() {
        var snapshot = NSDiffableDataSourceSnapshot<EpisodeSection, RMEpisode>()
